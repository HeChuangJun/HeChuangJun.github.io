import{_ as n}from"./plugin-vue_export-helper-DlAUqK2U.js";import{o as e,c as i,a as l}from"./app-BPKJBNij.js";const d={},s=l(`<p>MongoDB是nosql数据库的一种,对node.js有比较好的支持<br> 是非关系型数据库</p><ul><li><a href="#1-%E5%85%B3%E7%B3%BB%E5%9E%8B%E6%95%B0%E6%8D%AE%E5%BA%93%E4%B8%8E%E9%9D%9E%E5%85%B3%E7%B3%BB%E5%9E%8B%E6%95%B0%E6%8D%AE%E5%BA%93">1. 关系型数据库与非关系型数据库</a></li><li><a href="#2-mongodb%E6%98%AF%E6%9C%80%E6%8E%A5%E8%BF%91%E5%85%B3%E7%B3%BB%E5%9E%8B%E6%95%B0%E6%8D%AE%E5%BA%93%E7%9A%84%E9%9D%9E%E5%85%B3%E7%B3%BB%E5%9E%8B%E6%95%B0%E6%8D%AE%E5%BA%93">2. MongoDB是最接近关系型数据库的非关系型数据库</a></li><li><a href="#3-mongodb%E6%95%B0%E6%8D%AE%E5%BA%93%E7%9A%84%E5%9F%BA%E6%9C%AC%E6%A6%82%E5%BF%B5">3. mongodb数据库的基本概念</a></li><li><a href="#mongodb%E5%91%BD%E4%BB%A4">MongoDB命令</a></li><li><a href="#54-nodejs%E6%93%8D%E4%BD%9Cmongodb%E6%89%80%E6%9C%89%E5%AF%B9mongodb%E6%95%B0%E6%8D%AE%E5%BA%93%E6%93%8D%E4%BD%9C%E9%83%BD%E6%98%AF%E5%BC%82%E6%AD%A5%E7%9A%84">5.4. node.js操作mongodb(所有对mongodb数据库操作都是异步的)</a></li></ul><h1 id="_1-关系型数据库与非关系型数据库" tabindex="-1"><a class="header-anchor" href="#_1-关系型数据库与非关系型数据库"><span>1. 关系型数据库与非关系型数据库</span></a></h1><ul><li>关系型数据库是指表与表之间存在联系</li><li>所有关系型数据库在操作之前都要设计表结构</li><li>所有关系型数据库都要通过sql语音来操作</li><li>关系型数据库的表还支持约束</li><li>非关系型数据库非常灵活（键值对）</li></ul><h1 id="_2-mongodb是最接近关系型数据库的非关系型数据库" tabindex="-1"><a class="header-anchor" href="#_2-mongodb是最接近关系型数据库的非关系型数据库"><span>2. MongoDB是最接近关系型数据库的非关系型数据库</span></a></h1><ul><li>数据库→数据库；数据表→集合；表记录→文档对象</li></ul><h1 id="_3-mongodb数据库的基本概念" tabindex="-1"><a class="header-anchor" href="#_3-mongodb数据库的基本概念"><span>3. mongodb数据库的基本概念</span></a></h1><div class="language-text line-numbers-mode" data-ext="text" data-title="text"><pre class="language-text"><code>数据库（大对象）→集合（数组）→文档（小对象）
{
	a(数据库):{
		aa(集合):[
			{&quot;name&quot;:&quot;junye1&quot;},（文档1）
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div>`,12),o=[s];function a(t,r){return e(),i("div",null,o)}const c=n(d,[["render",a],["__file","mongodb.html.vue"]]),u=JSON.parse('{"path":"/backend/database/mongodb.html","title":"MongoDB","lang":"zh-CN","frontmatter":{"title":"MongoDB","date":"2023-01-01T00:00:00.000Z","tags":"MongoDB","categories":"数据库","description":"MongoDB是nosql数据库的一种,对node.js有比较好的支持 是非关系型数据库 1. 关系型数据库与非关系型数据库 2. MongoDB是最接近关系型数据库的非关系型数据库 3. mongodb数据库的基本概念 MongoDB命令 5.4. node.js操作mongodb(所有对mongodb数据库操作都是异步的) 1. 关系型数据库与非关...","head":[["meta",{"property":"og:url","content":"https://javaguide.cn/backend/database/mongodb.html"}],["meta",{"property":"og:site_name","content":"JavaGuide"}],["meta",{"property":"og:title","content":"MongoDB"}],["meta",{"property":"og:description","content":"MongoDB是nosql数据库的一种,对node.js有比较好的支持 是非关系型数据库 1. 关系型数据库与非关系型数据库 2. MongoDB是最接近关系型数据库的非关系型数据库 3. mongodb数据库的基本概念 MongoDB命令 5.4. node.js操作mongodb(所有对mongodb数据库操作都是异步的) 1. 关系型数据库与非关..."}],["meta",{"property":"og:type","content":"article"}],["meta",{"property":"og:locale","content":"zh-CN"}],["meta",{"property":"og:updated_time","content":"2024-07-12T06:32:47.000Z"}],["meta",{"property":"article:author","content":"HeChuangJun"}],["meta",{"property":"article:published_time","content":"2023-01-01T00:00:00.000Z"}],["meta",{"property":"article:modified_time","content":"2024-07-12T06:32:47.000Z"}],["script",{"type":"application/ld+json"},"{\\"@context\\":\\"https://schema.org\\",\\"@type\\":\\"Article\\",\\"headline\\":\\"MongoDB\\",\\"image\\":[\\"\\"],\\"datePublished\\":\\"2023-01-01T00:00:00.000Z\\",\\"dateModified\\":\\"2024-07-12T06:32:47.000Z\\",\\"author\\":[{\\"@type\\":\\"Person\\",\\"name\\":\\"HeChuangJun\\",\\"url\\":\\"https://javaguide.cn/article/\\"}]}"]]},"headers":[],"git":{"createdTime":1720765967000,"updatedTime":1720765967000,"contributors":[{"name":"HeChuangJun","email":"1105128664@qq.com","commits":1}]},"readingTime":{"minutes":3.64,"words":1091},"filePathRelative":"backend/database/mongodb.md","localizedDate":"2023年1月1日","excerpt":"<p>MongoDB是nosql数据库的一种,对node.js有比较好的支持<br>\\n是非关系型数据库</p>\\n<!--more-->\\n<!-- TOC -->\\n<ul>\\n<li><a href=\\"#1-%E5%85%B3%E7%B3%BB%E5%9E%8B%E6%95%B0%E6%8D%AE%E5%BA%93%E4%B8%8E%E9%9D%9E%E5%85%B3%E7%B3%BB%E5%9E%8B%E6%95%B0%E6%8D%AE%E5%BA%93\\">1. 关系型数据库与非关系型数据库</a></li>\\n<li><a href=\\"#2-mongodb%E6%98%AF%E6%9C%80%E6%8E%A5%E8%BF%91%E5%85%B3%E7%B3%BB%E5%9E%8B%E6%95%B0%E6%8D%AE%E5%BA%93%E7%9A%84%E9%9D%9E%E5%85%B3%E7%B3%BB%E5%9E%8B%E6%95%B0%E6%8D%AE%E5%BA%93\\">2. MongoDB是最接近关系型数据库的非关系型数据库</a></li>\\n<li><a href=\\"#3-mongodb%E6%95%B0%E6%8D%AE%E5%BA%93%E7%9A%84%E5%9F%BA%E6%9C%AC%E6%A6%82%E5%BF%B5\\">3. mongodb数据库的基本概念</a></li>\\n<li><a href=\\"#mongodb%E5%91%BD%E4%BB%A4\\">MongoDB命令</a></li>\\n<li><a href=\\"#54-nodejs%E6%93%8D%E4%BD%9Cmongodb%E6%89%80%E6%9C%89%E5%AF%B9mongodb%E6%95%B0%E6%8D%AE%E5%BA%93%E6%93%8D%E4%BD%9C%E9%83%BD%E6%98%AF%E5%BC%82%E6%AD%A5%E7%9A%84\\">5.4. node.js操作mongodb(所有对mongodb数据库操作都是异步的)</a></li>\\n</ul>","autoDesc":true}');export{c as comp,u as data};
