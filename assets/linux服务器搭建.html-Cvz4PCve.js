...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="dubbo的注册中心zookeeper的安装" tabindex="-1"><a class="header-anchor" href="#dubbo的注册中心zookeeper的安装"><span>Dubbo的注册中心Zookeeper的安装</span></a></h2><pre><code>Zookeeper是java开发的可以运行在windows、linux环境。需要先安装jdk。
