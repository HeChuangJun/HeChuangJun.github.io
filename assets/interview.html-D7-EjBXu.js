...
答案： C
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="_16-4-计算n的阶乘的末尾有几个0√" tabindex="-1"><a class="header-anchor" href="#_16-4-计算n的阶乘的末尾有几个0√"><span>16.4. 计算n的阶乘的末尾有几个0√</span></a></h2>`,49),u={href:"http://www.99cankao.com/statistics/factorial-calculator.php",target:"_blank",rel:"noopener noreferrer"},b=n("br",null,null,-1),m=s(`<div class="language-text line-numbers-mode" data-ext="text" data-title="text"><pre class="language-text"><code>public static int SelectZero(int n){
    int count=0;
    while(n!=0){
        count+=n/5;
        n=n/5;
