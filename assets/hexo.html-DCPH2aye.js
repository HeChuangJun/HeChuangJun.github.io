import{_ as e}from"./plugin-vue_export-helper-DlAUqK2U.js";import{o as n,c as i,a as t}from"./app-DqkiJzuz.js";const s={},a=t(`<p>记录一下搭建博客</p><ul><li><a href="#1-%E9%85%8D%E7%BD%AE">1. 配置</a></li><li><a href="#2-vscode%E9%85%8D%E7%BD%AE">2. VSCode配置</a></li></ul><h1 id="_1-配置" tabindex="-1"><a class="header-anchor" href="#_1-配置"><span>1. 配置</span></a></h1><div class="language-text line-numbers-mode" data-ext="text" data-title="text"><pre class="language-text"><code># 安装：node.js、git
# 创建博客文件夹 
- hexo init
# 安装依赖包
- npm install
...
- hexo server
# 创建  用户名.github.io 仓库
# 编辑本地Hexo目录下文件_comfig.yml,在最后添加如下代码
deploy:
  type: git
