import{_ as e}from"./plugin-vue_export-helper-DlAUqK2U.js";import{o as n,c as i,a as t}from"./app-Cw8r8IGg.js";const s={},a=t(`<p>最好的API使用Swagger工具构建</p><h1 id="_1-springboot整合swagger2" tabindex="-1"><a class="header-anchor" href="#_1-springboot整合swagger2"><span>1. springboot整合swagger2</span></a></h1><div class="language-text line-numbers-mode" data-ext="text" data-title="text"><pre class="language-text"><code>导入swagger依赖（在maven项目pom.xml中添加以下依赖）
&lt;dependency&gt;
